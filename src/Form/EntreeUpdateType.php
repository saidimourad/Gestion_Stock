...
class EntreeUpdateType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('commande', EntityType::class, ['class'=>Commande::class, 'choices' => $this->commandeRepository->UpdateCommandeByMG($this->security->getUser()->getId()),  'label' => 'Commande','attr' => array('class'=>'select2 ',  'required' => true) ])
