...
class AffecterChefuniteType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
           // ->add('user' , EntityType::class ,array('class'=>User::class,'choice_label' => 'email', 'attr' => array('class'=>'select2 form-control') ))
            ->add('user', EntityType::class, ['class'=>User::class, 'choices' => $this->userRepository->findByRole("ROLE_CHEFUNITE"),  'label' => 'Chef d"unité', 'attr' => array('class'=>'select2 form-control',  'required' => true) ])
